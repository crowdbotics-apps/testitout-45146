"""
Django settings for testitout_45146 project.
...
ROOT_URLCONF = 'testitout_45146.urls'
...
WSGI_APPLICATION = 'testitout_45146.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testitout_45146 API",
    "DESCRIPTION": "API documentation for testitout_45146 App",
    "VERSION": "v1",
}
